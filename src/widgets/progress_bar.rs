// modified from https://docs.rs/egui/latest/src/egui/widgets/progress_bar.rs.html
// added "desired_height" option
...
impl ProgressBar {
    ...
    /// The desired height of the bar. Will use vertical spacing if not set.
